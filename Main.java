...
public class Main {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader(filename))) {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                if (resultOfSplit.length > 0 && resultOfSplit.length < 4 &&
                        ...
                        isWithinSprint(resultOfSplit[2])) {
    ...
    /**
     * Проверяет, находится ли дата коммита в пределах спринта.
     * @param dateTime дата и время коммита в формате "YYYY-MM-ddTHH:mm:ss.SSS"
     * @return true, если дата коммита в пределах спринта, иначе false
     */
    public static boolean isWithinSprint(String dateTime) {
