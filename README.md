...
2. Подсчет количества коммитов для каждого пользователя с использованием словаря.
3. Поиск 3-х самых активных пользователей с помощью минимальной кучи.
4. Формирование списка имен пользователей в нужном порядке.
...
- Скачайте файл `main.py` из репозитория.
- Поместите файл `main.py` в папку с файлом `commits.txt`.
- Запустите программу, выполнив команду `python main.py` или запустив файл `main.py` в вашей среде разработки.
