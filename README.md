...
На постоянке пользуюсь только тг и периодически почтой: @salomolekula и gorstvlad900@gmail.com
...
Решение разбито на несколько файлов, поэтому можно либо засунуть все функции из них в файл с main, либо реализвать также, как в репозитории. Файлик добавить в корневую папку с решением:
